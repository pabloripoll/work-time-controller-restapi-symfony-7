...
/**
 * Admin use case: get all employee access logs across all employees
 */
final readonly class GetAllEmployeeAccessLogsHandler
{
     ...
     */
    public function __invoke(GetAllEmployeeAccessLogsQuery $query): array
    {
        if ($query->userId) {
            $userId = $query->userId;
