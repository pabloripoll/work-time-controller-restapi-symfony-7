...
final class UserRepositoryTest extends KernelTestCase
{
    ...
    public function testSaveAndFindById(): void
    {
        ...
        $this->assertEquals((int)$userId, (string)$foundUser->getId());
    ...
    public function testFindByEmailAndRole(): void
    {
        ...
        $foundUser = $this->repository->findByEmailAndRole($email, UserRole::EMPLOYEE);
        $this->assertNotNull($foundUser);
    ...
    public function testSoftDelete(): void
    {
        ...
        $result = $this->repository->findByRolePaginated(UserRole::EMPLOYEE, 1, 10);

        // Should not include soft-deleted users
        $ids = array_map(fn($u) => (string)$u->getId(), $result['data']);
        $this->assertNotContains((int)$userId, $ids);
    }

    public function testCountByRole(): void
    {
        $initialCount = $this->repository->countByRole(UserRole::EMPLOYEE);
        ...
        $newCount = $this->repository->countByRole(UserRole::EMPLOYEE);
    ...
    public function testPaginationWorks(): void
    {
        ...
        $page1 = $this->repository->findByRolePaginated(UserRole::EMPLOYEE, 1, 2);
        ...
        // Test second page
        $page2 = $this->repository->findByRolePaginated(UserRole::EMPLOYEE, 2, 2);
        ...
        $page3 = $this->repository->findByRolePaginated(UserRole::EMPLOYEE, 3, 2);
